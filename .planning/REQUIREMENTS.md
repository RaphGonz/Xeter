...
- [x] **UI-02**: Trace detail page renders a collapsible span tree using `parent_span_id` — spans with no parent rendered at root level; children nested beneath parent; each span row shows flag type badges
