...
**Plans**: 2 plans
Plans:
- [x] 18-01-PLAN.md — Dead code removal + stale comment correction + env var audit (CLEAN-01, CLEAN-02, CLEAN-03)
- [x] 18-02-PLAN.md — BaseAnalyzer 3-class hierarchy refactor (TANA-01)
...
**Plans**: 3 plans
Plans:
- [x] 19-01-PLAN.md — TraceAnalyzer scaffold class + unit tests (TANA-02)
- [x] 19-02-PLAN.md — Migration 005 + Flag ORM update + flag_writer nullable span_id (TANA-04)
- [x] 19-03-PLAN.md — Worker trace buffer + flush-timeout wiring + tests (TANA-03)
...
**Plans**: 2 plans
Plans:
- [x] 20-01-PLAN.md — GET /traces + GET /traces/{trace_id} router implementation + wire into main.py (TRACE-01, TRACE-02)
- [x] 20-02-PLAN.md — Unit tests for both trace endpoints (TRACE-01, TRACE-02)
...
**Plans**: 3 plans
Plans:
- [x] 21-01-PLAN.md — Trace API types + listTraces/getTraceDetail functions + TraceTable component + /traces page + layout + NavBar link (UI-01)
- [x] 21-02-PLAN.md — SpanTree collapsible component + /traces/[trace_id] detail page (UI-02)
- [x] 21-03-PLAN.md — Breadcrumb on SpanDetailPanel for back-navigation to trace (UI-03)
